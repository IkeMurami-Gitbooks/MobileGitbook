...
* [iOS](programming/untitled/README.md)
  ...
  * [Xcode: Build Project via command line](programming/untitled/xcode-build-project-via-command-line.md)
...
* [Уязвимости и Атаки](pentest/attacks-and-vulnerabilities/README.md)
  * [Изи баги](pentest/attacks-and-vulnerabilities/izi-bagi.md)
  * [Common](pentest/attacks-and-vulnerabilities/common.md)
  * [iOS](pentest/attacks-and-vulnerabilities/ios.md)
  * [Android](pentest/attacks-and-vulnerabilities/android.md)
  * [AppLinks](pentest/attacks-and-vulnerabilities/applinks.md)
  * [Auth](pentest/attacks-and-vulnerabilities/auth/README.md)
    * [Biometrics bypass](pentest/attacks-and-vulnerabilities/auth/biometrics-bypass.md)
    * [PIN Bruteforce](pentest/attacks-and-vulnerabilities/auth/pin-bruteforce.md)
    * [Типичные ошибки реализации SMS-аутентификации](pentest/attacks-and-vulnerabilities/auth/tipichnye-oshibki-realizacii-sms-autentifikacii.md)
  * [USSD Attack](pentest/attacks-and-vulnerabilities/ussd-attack.md)
  * [Java Object Deserialization](pentest/attacks-and-vulnerabilities/java-object-deserialization.md)
  * [Lack of binary protection (anti-debugging) controls](pentest/attacks-and-vulnerabilities/lack-of-binary-protection-anti-debugging-controls.md)
  * [Disabled security features in binary libraries](pentest/attacks-and-vulnerabilities/disabled-security-features-in-binary-libraries.md)
  * [Lack of exploit mitigations (e.g. PIE, ARC, or stack canaries)](pentest/attacks-and-vulnerabilities/lack-of-exploit-mitigations-e.g.-pie-arc-or-stack-canaries.md)
  * [Path disclosure in the binary](pentest/attacks-and-vulnerabilities/path-disclosure-in-the-binary.md)
  * [Runtime hacking exploits (e.g. exploits that are only possible in a jailbroken environment)](pentest/attacks-and-vulnerabilities/runtime-hacking-exploits-e.g.-exploits-that-are-only-possible-in-a-jailbroken-environment.md)
  * [Snapshot/pasteboard leakage](pentest/attacks-and-vulnerabilities/snapshot-pasteboard-leakage.md)
  * [User data stored unencrypted in the file system and/or external storage](pentest/attacks-and-vulnerabilities/user-data-stored-unencrypted-in-the-file-system-and-or-external-storage.md)
  * [Android Task Hijacking](pentest/attacks-and-vulnerabilities/android-task-hijacking.md)
  * [WebView](pentest/attacks-and-vulnerabilities/webview/README.md)
    * [Check list](pentest/attacks-and-vulnerabilities/webview/check-list.md)
    * [Example Web View XSS in iOS app](pentest/attacks-and-vulnerabilities/webview/example-web-view-xss-in-ios-app.md)
    * [CVE-2020-6506: uXSS in Android WebView](pentest/attacks-and-vulnerabilities/webview/cve-2020-6506-uxss-in-android-webview.md)
