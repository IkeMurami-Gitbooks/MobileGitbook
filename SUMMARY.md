...
* [Android](programming/android/README.md)
  ...
  * [Building & Distribution](programming/android/building-and-distribution/README.md)
    * [Gradle](programming/android/building-and-distribution/gradle-1/README.md)
      * [Intro](programming/android/building-and-distribution/gradle-1/gradle.md)
      * [Про репозитории библиотек](programming/android/building-and-distribution/gradle-1/pro-repozitorii-bibliotek.md)
      * [Upgrade Gradle Version](programming/android/building-and-distribution/gradle-1/upgrade-gradle-version.md)
      * [Flavors & BuildTypes](programming/android/building-and-distribution/gradle-1/flavors-and-buildtypes.md)
      * [Пример использования Kotlin DSL синтаксиса](programming/android/building-and-distribution/gradle-1/primer-ispolzovaniya-kotlin-dsl-sintaksisa.md)
    * [Fastlane](programming/android/building-and-distribution/fastlane.md)
    * [Automating build](programming/android/building-and-distribution/automating-build.md)
